...
public class BankToCustomerStatementCamt053 {
    ...
    public static class InstructedAgent {
        @XmlElement(name = "FinInstnId", required = true)
        private FinancialInstitutionIdSimplified finInstnId;
    }
    ...
    @NoArgsConstructor
    @Builder
    public static class FinancialInstitutionIdSimplified {
        @XmlElement(name = "BICFI")
        private String bicfi;
    }
}
